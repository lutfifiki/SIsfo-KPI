				...
				<div class="col-lg-12">
					<div class="card">
                        <div class="card-header">
                            <strong>Edit</strong> Penilaian Unit Kerja UTSG
                        </div>
                            <div class="card-body card-block">

                                <form action="/aspek_penilaian/{{$aspekpenilaian->id}}/update" method="post" enctype="multipart/form-data">
				     {{csrf_field()}}
                            ...
                            <div class="row form-group">
                                <div class="col col-md-12">
                                    <label for="text-input" class="form-control-label">Standart KPI</label>
                                </div>
                                    <div class="col-12">
